...
import { Concept } from '../../../data/models/offense';
...
export class ConceptsComponent implements OnInit {
  ...
  modalData: any;
  @ViewChild("conceptVideoViewContent", { static: true })
  conceptVideoViewContent!: ElementRef<HTMLElement>;
  searchText: any;
  ...
  reloadTable() {
    ...
    // }
    this.selectedRow = [];
    this.offensePublicService.publicConceptSearch(searchParam)
      .pipe(first())
      .subscribe((resp: any) => {
        if (resp.success) {
  ...
  openVideoModal(data: any) {
    this.modalData = data;
    this.modalService.open(this.conceptVideoViewContent, { centered: true, size: "xl" });
  };
